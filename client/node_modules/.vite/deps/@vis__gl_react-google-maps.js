...
var _excluded$4 = ["onLoad", "apiKey", "version", "libraries"];
...
function useGoogleMapsApiLoader(props) {
  const {
    ...
    version,
    libraries = []
  } = props, otherApiParams = _objectWithoutPropertiesLoose(props, _excluded$4);
...
function useMapOptions(map, cameraStateRef, mapProps) {
  const {
    ...
    heading,
    tilt
  } = mapProps, mapOptions = _objectWithoutPropertiesLoose(mapProps, _excluded$3);
...
var Map = (props) => {
  ...
  const isViewportSet = (0, import_react.useMemo)(() => Boolean(viewport), [viewport]);
...
function useAdvancedMarker(props) {
  ...
  (0, import_react.useEffect)(() => {
    if (!marker) return;
    if (position !== void 0) marker.position = position;
...
var useAutocomplete = (props) => {
  ...
  const placeChangedHandler = (0, import_react.useRef)(onPlaceChanged);
  const [autocomplete, setAutocomplete] = (0, import_react.useState)(null);
  (0, import_react.useEffect)(() => {
